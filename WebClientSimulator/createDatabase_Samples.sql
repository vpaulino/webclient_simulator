...
/****** Object:  Database [Samples]    Script Date: 11/11/2012 21:04:13 ******/
CREATE DATABASE [Samples] ON  PRIMARY 
( NAME = N'Samples', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL10.MSSQL\MSSQL\DATA\Samples.mdf' , SIZE = 3072KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'Samples_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL10.MSSQL\MSSQL\DATA\Samples_log.ldf' , SIZE = 1024KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
GO

ALTER DATABASE [Samples] SET COMPATIBILITY_LEVEL = 100
GO
...
ALTER DATABASE [Samples] SET AUTO_CREATE_STATISTICS ON 
GO
...
ALTER DATABASE [Samples] SET RECOVERY FULL 
GO
